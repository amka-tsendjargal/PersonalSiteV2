...
export default function Project({
    ...
    return (
        <div className={`lg:flex items-center md:h-screen w-full lg:px-28 pt-28 pb-0 md:py-28 ${reverse ? 'lg:flex-row-reverse' : ''}`}>
            ...
            <div className="lg:w-1/2 lg:max-h-full lg:flex lg:flex-col justify-center p-5 lg:p-20">
                ...
                <h1 className="text-sm xl:text-xl mt-5">
                    <a href={projectLink} className="text-white bg-sky-600 hover:bg-sky-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 focus:outline-none">GitHub</a>
                </h1>
            </div>
        </div>
