        ...
        <div id="about" className="flex w-screen md:min-h-screen">
            <div className="flex flex-col md:flex-row gap-2 md:items-center w-full md:h-screen py-28 md:px-28">
                ...
                <div className="flex flex-col px-5 md:w-1/2">
                    ...
                    <h1 className="text-sm md:text-base xl:text-2xl mb-4">Now I&apos;m enrolled in the Object-Oriented Software Development program at SAIT, <strong>currently looking for internships and junior roles.</strong> In my free time, I&apos;m either working on personal projects or planning the next one.</h1>
